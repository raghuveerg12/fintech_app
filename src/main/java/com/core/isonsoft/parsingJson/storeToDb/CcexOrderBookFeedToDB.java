 ...
 *
 */
public class CcexOrderBookFeedToDB extends TimerTask {

	/** LOGGER */
	public final static Logger LOG = LoggerFactory
			.getLogger(CcexOrderBookFeedToDB.class);
	...
	/** The Constant id. */
	public final static String codeDataSourceId = "44";
	...
	public static void main(String[] args) throws JsonParseException,
		 ...
		 * ,mapper,"C:\\Users\\raghu\\Desktop\\faliure\\44.json"
		 * ,System.currentTimeMillis(),"44",session);
		 */

		Timer timer = new Timer();
		timer.scheduleAtFixedRate(new CcexOrderBookFeedToDB(), 0,
				60 * 60 * 1000);
	}
