 ...
 *
 */
public class CoinMarketCapGlobalFeedToDB extends TimerTask {
	/** LOGGER */
	public final static Logger LOG = LoggerFactory
			.getLogger(CoinMarketCapGlobalFeedToDB.class);
	...
	/** The Constant id. */
	public final static String codeDataSourceId = "49";
	...
	public static void main(String[] args) throws JsonParseException,
		 ...
		 * "C:\\Users\\raghu\\Desktop\\faliure\\49.json"
		 * ,System.currentTimeMillis(),"49",session);
		 */
		Timer timer = new Timer();
		timer.scheduleAtFixedRate(new CoinMarketCapGlobalFeedToDB(), 0,
				60 * 60 * 1000);
	}
	...
	public static void convertJsonDataToDb(String path, long systemTime,
		...
		try {
			...
			session.save(StagCoinMarketCapGlobalBean);
