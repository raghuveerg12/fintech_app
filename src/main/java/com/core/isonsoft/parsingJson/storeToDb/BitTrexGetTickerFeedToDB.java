...
public class BitTrexGetTickerFeedToDB extends TimerTask {
	/** LOGGER */
	public final static Logger LOG = LoggerFactory
			.getLogger(BitTrexGetTickerFeedToDB.class);
	...
	/** The Constant id. */
	public final static String codeDataSourceId = "31";
	...
	public static void main(String[] args) throws JsonParseException,
		 ...
		 * "C:\\Users\\raghu\\Desktop\\faliure\\31.json"
		 * ,System.currentTimeMillis(),"31",session);
		 */
		Timer timer = new Timer();
		timer.scheduleAtFixedRate(new BitTrexGetTickerFeedToDB(), 0,
				60 * 60 * 1000);
	}
	...
	public static void convertJsonDataToDb(String path, long systemTime,
		...
		try {
			...
			session.save(stagBitTrexGetMarketsBean);
