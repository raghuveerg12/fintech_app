 ...
 *
 */
public class CcexVolumeBtcFeedToDB extends TimerTask {

	/** LOGGER */
	public final static Logger LOG = LoggerFactory
			.getLogger(CcexVolumeBtcFeedToDB.class);
	...
	/** The Constant id. */
	public final static String codeDataSourceId = "42";
	...
	public static void main(String[] args) throws JsonParseException,
		 ...
		 * ,mapper,"C:\\Users\\raghu\\Desktop\\faliure\\42.json"
		 * ,System.currentTimeMillis(),"42",session);
		 */
		Timer timer = new Timer();
		timer.scheduleAtFixedRate(new CcexVolumeBtcFeedToDB(), 0,
				60 * 60 * 1000);
	}
