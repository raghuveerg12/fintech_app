 ...
 *
 */
public class CcexGetBalanceDistributionFeedToDB extends TimerTask {
	/** LOGGER */
	public final static Logger LOG = LoggerFactory
			.getLogger(CcexGetBalanceDistributionFeedToDB.class);
	...
	/** The Constant id. */
	public final static String codeDataSourceId = "47";
	...
	public static void main(String[] args) throws JsonParseException,
		 ...
		 * ,mapper,"C:\\Users\\raghu\\Desktop\\faliure\\47.json"
		 * ,System.currentTimeMillis(),"47",session);
		 */
		
		
		Timer timer = new Timer();
		timer.scheduleAtFixedRate(new CcexGetBalanceDistributionFeedToDB(), 0,
				60 * 60 * 1000);
	}
