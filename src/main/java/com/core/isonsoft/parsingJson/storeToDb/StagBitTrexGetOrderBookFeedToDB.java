 ...
 *
 */
public class StagBitTrexGetOrderBookFeedToDB extends TimerTask {

	/** LOGGER */
	public final static Logger LOG = LoggerFactory
			.getLogger(StagBitTrexGetOrderBookFeedToDB.class);
	...
	/** The Constant id. */
	public final static String codeDataSourceId = "33";
	...
	public static void main(String[] args) throws JsonParseException,
		 ...
		 * "C:\\Users\\raghu\\Desktop\\faliure\\33.json"
		 * ,System.currentTimeMillis(),"33",session);
		 */
		
		/*Session session=HibernateUtil.getSessionFactory().openSession();
		  session.beginTransaction();
		  convertJsonDataToDb( "C:\\Users\\raghu\\Desktop\\faliure\\33.json",System.currentTimeMillis(),session);*/

		Timer timer = new Timer();
		timer.scheduleAtFixedRate(new StagBitTrexGetOrderBookFeedToDB(), 0,
				60 * 60 * 1000);
	}
	...
	public static void convertJsonDataToDb(String path, long systemTime,
			Session session) {
		try {
			List<Object> list=new BitTrexGetOrderBookHelper().convertJsonDataToList(path);
