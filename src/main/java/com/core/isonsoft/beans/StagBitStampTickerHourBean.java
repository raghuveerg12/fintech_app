...
@Entity
@Table(name = "StagBitStampTickerHour")
public class StagBitStampTickerHourBean {
	...
	public String toString() {
		return "StagBitStampTickerHourBean [id=" + id + ", high=" + high
	...
	public StagBitStampTickerHourBean() {

	}

	public StagBitStampTickerHourBean(int id, double high, double last,
